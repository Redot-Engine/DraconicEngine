...
struct alignas(8) Vector2 {
	...
	operator[](i32 i0, i32 i1, i32 i2) const noexcept;
	[[nodiscard]] constexpr Vector4
	operator[](i32 i0, i32 i1, i32 i2, i32 i3) noexcept;
	[[nodiscard]] constexpr Vector4
	operator[](i32 i0, i32 i1, i32 i2, i32 i3) const noexcept;

	// operators
	[[nodiscard]] constexpr Vector2 operator+() const noexcept;
	[[nodiscard]] constexpr Vector2 operator-() const noexcept;
	[[nodiscard]] constexpr bool
	operator==(Vector2 const &other) const noexcept = default;
...
struct alignas(16) Vector3 {
	...
	[[nodiscard]] constexpr explicit Vector3(Vector2 const &xy,
	                                         f32 z = 0.0F) noexcept;
	...
	spherical(f32 azimuth, f32 inclination, f32 radius = 1.0F) noexcept;
	[[nodiscard]] static Vector3
	cylindrical(f32 angle, f32 radius = 1.0F, f32 height = 0.0F) noexcept;
	...
	[[nodiscard]] constexpr Vector3 operator-() const noexcept;
	[[nodiscard]] constexpr bool
	operator==(Vector3 const &other) const noexcept = default;
...
struct alignas(16) Vector4 {
	...
	[[nodiscard]] constexpr Vector4(Vector2 const &xy,
	                                Vector2 const &zw) noexcept;
	[[nodiscard]] constexpr explicit Vector4(Vector3 const &xyz,
	                                         f32 w = 0.0F) noexcept;
	...
	[[nodiscard]] constexpr Vector4 operator-() const noexcept;
	[[nodiscard]] constexpr bool
	operator==(Vector4 const &other) const noexcept = default;
...
template<typename T> consteval T
select(draco::i32 const i, T const v1, T const v2) {
	switch (i) {
	case 0:  return v1;
	case 1:  return v2;
...
template<typename T> consteval T
select(draco::i32 const i, T const v1, T const v2, T const v3) {
	switch (i) {
	case 0:  return v1;
	case 1:  return v2;
	case 2:  return v3;
...
template<typename T> consteval T
select(draco::i32 const i, T const v1, T const v2, T const v3, T const v4) {
	switch (i) {
	case 0:  return v1;
	case 1:  return v2;
	case 2:  return v3;
